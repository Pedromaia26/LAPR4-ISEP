...
public class MaintenanceAGVRequest extends AgvManagerProtocolRequest{

    private AGVManagerController agvManagerController = new AGVManagerControllerImpl();
    private String agvID;

    protected MaintenanceAGVRequest(AGVManagerController controller, String inputData) {
    ...
    public String execute() {
        ...
        // execution
        try{
            agvManagerController.AGVinMaintenance(agvID);
    ...
    public byte[] outputProtocol() {
        ...
        byte[] array = new byte[]{CommunicationProtocol.PROTOCOL_V1,
                CommunicationProtocol.UPDATE_AGV_STATUS_MAINTENANCE_RESPONSE_CODE, dataLength[0], dataLength[1]};
        return array;
    }

    private String buildResponse() {
        return String.format("AGV %s is in maintenance.", agvID);
    }
}
