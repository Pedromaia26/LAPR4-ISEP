...
public class StatusBootstrapperBase {
    private static final Logger LOGGER = LoggerFactory.getLogger(UsersBootstrapperBase.class);

    final AddStatusController statusController = new AddStatusController();

    public StatusBootstrapperBase() {
        super();
    }
     ...
     * @param description
     */
    protected boolean addStatus(final String description) {
        try {
            statusController.addStatus(description);
