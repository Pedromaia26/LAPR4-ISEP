...
public interface SurveyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SurveyParser#option}.
	 * @param ctx the parse tree
	 */
	void enterOption(SurveyParser.OptionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SurveyParser#option}.
	 * @param ctx the parse tree
	 */
	void exitOption(SurveyParser.OptionContext ctx);
	/**
